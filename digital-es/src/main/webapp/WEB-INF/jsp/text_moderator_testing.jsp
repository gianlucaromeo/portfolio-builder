...
<head>
    ...
    <link rel="stylesheet" href="../../dashboard_assets/bootstrap/css/bootstrap.min.css">
...
<body class="bg-gradient-primary">
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;../../dashboard_assets/img/dogs/image3.jpeg&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" id="loginForm" method="post">
                                        ...
                                        </div><button class="btn btn-primary d-block btn-user w-100" type="submit" id="testBtn">Login</button>
                                        <hr>
									<a
									class="btn btn-primary d-block btn-google btn-user w-100 mb-2"
									role="button" id="googleLoginBtn"><i class="fab fa-google"></i>&nbsp;
									Login with Google</a>                                        <hr>
                                    </form>
	...
	<script src="../../dashboard_assets/js/text_moderator.js"></script>
</body>
