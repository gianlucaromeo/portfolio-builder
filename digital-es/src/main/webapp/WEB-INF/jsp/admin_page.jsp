										...
										<div class="card-body">
											<form>
												...
												<div class="row">
													<div class="col">
														<div class="mb-3">
															<label class="form-label" for="city"><strong>Facebook
																	</strong></label><input class="form-control" type="text"
																id="facebookLinkRef" placeholder="" name="facebook_link_ref">
														</div>
													</div>
													<div class="col">
														<div class="mb-3">
															<label class="form-label" for="city"><strong>Instagram
																</strong></label><input class="form-control" type="text"
																id="instagramLinkRef" placeholder="" name="instagram_link_ref">
														</div>
													</div>
													<div class="col">
														<div class="mb-3">
															<label class="form-label" for="city"><strong>Twitter
																	</strong></label><input class="form-control" type="text"
																id="twitterLinkRef" placeholder="" name="twitter_link_ref">
														</div>
													</div>
												</div>
												<div class="mb-3">
