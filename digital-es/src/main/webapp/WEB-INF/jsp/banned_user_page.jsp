...
<body class="gradient">
	...
	<div id="notfound">
		<div class="notfound">
			...
			<h2>We are sorry, but your account has been banned.</h2>
			<div class="row justify-content-center">
				<div class="col-12 col-md-6">
					<a class="btn btn-primary m-2 gradient error-btn-redirect"
						role="button" href="/home">Show Homepage</a>
				</div>
			</div>
		</div>
	</div>
